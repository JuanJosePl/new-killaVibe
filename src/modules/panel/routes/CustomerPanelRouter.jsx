...
const CustomerDashboardPage = lazy(() =>
  import("../../customer/pages/CustomerDashboardPage")
);
const Cart = lazy(() => import("../../customer/pages/CustomerCartPage"));
const Wishlist = lazy(() => import("../../customer/pages/CustomerWishlistPage"));
const Orders = lazy(() => import("../../customer/pages/CustomerOrdersPage"));
const OrderDetail = lazy(() => import("../../customer/pages/CustomerOrderDetailPage"));
const Profile = lazy(() => import("../../customer/pages/CustomerProfilePage"));
const Reviews = lazy(() => import("../../customer/pages/CustomerReviewsPage"));
const Contact = lazy(() => import("../../customer/pages/CustomerContactPage"));

// ✅ PRODUCTS
const Products = lazy(() => import("../../customer/pages/CustomerProductsPage"));
const ProductDetail = lazy(() => import("../../customer/pages/CustomerProductDetailPage"));

// ✅ CATEGORIES
const Categories = lazy(() => import("../../customer/pages/CustomerCategoriesPage"));
const CustomerCategoryDetailPage = lazy(() =>
  import("../../customer/pages/CustomerCategoryDetailPage")
);
